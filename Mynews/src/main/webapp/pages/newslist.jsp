...
<body>
	...
	<div class="header-bottom">
		<div class="container">
			<div class="logo">
				<h1><a href="index.html">天海广纳</a></h1>
				<p><label class="of"></label>新闻列表<label class="on"></label></p>
			</div>
		</div>
	</div>
<!-- banner -->
		...
		<div class="col-md-9 technology-left">
			...
			<c:forEach items="${newslist}" var="n" varStatus="s">
				...
				<div class="col-md-6 blog-grid">
					...
					<div class="more m1">
						<a class="btn effect6" href="${n.url1}">使用模板1阅读</a>
						<a class="btn effect6" href="${n.url2}">使用模板2阅读</a>
					</div>
				</div>
				</c:forEach>
				<div class="clearfix"> </div>
					...
					<h4>其他新闻 </h4>
						<div class="blog-grids">
							<div class="blog-grid-left">
								<a href="*"><img src="images/t2.jpg" class="img-responsive" alt=""></a>
							</div>
							<div class="blog-grid-right">
								
								<h5><a href="*">Pellentesque dui Maecenas male</a> </h5>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="blog-grids">
						...
						<div class="blog-grids">
							<div class="blog-grid-left">
								<a href="*"><img src="images/t3.jpg" class="img-responsive" alt=""></a>
							</div>
							<div class="blog-grid-right">
